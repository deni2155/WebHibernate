                        ...
                        <table class="table table-striped table-hover align-middle fs-6">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th scope="col">
                                        <label for="name-org" class="form-label font-custom-table-header">Наименование организации</label>
                                        <div class="input-group">
                                            <button class="btn btn-custom btn-custom-sort">
                                                <!--Иконка сортировки-->
                                                <img src=""/>
                                            </button>
                                            <input type="text" class="form-control form-control-sm" name="member-name-org" id="name-org"/>
                                        </div>
                                    </th>
                                    <th scope="col">											
                                        <div>
                                            <label for="email-org" class="form-label font-custom-table-header">Адресат</label>
                                            <div class="input-group">
                                                <button class="btn btn-custom btn-custom-sort" type="button">
                                                    <!--Иконка сортировки-->
                                                    <img src=""/>
                                                </button>
                                                <input type="text" class="form-control form-control-sm" name="member-email-org" id="email-org"/>
                                            </div>
                                        </div>
                                    </th>
                                    <th scope="col">											
                                        <div>
                                            <label for="guid-org" class="form-label font-custom-table-header">GUID</label>
                                            <div class="input-group">
                                                <button class="btn btn-custom btn-custom-sort" type="button">
                                                    <!--Иконка сортировки-->
                                                    <img src=""/>
                                                </button>
                                                <input type="text" class="form-control form-control-sm" name="member-guid-org" id="guid-org"/>
                                            </div>
                                        </div>
                                    </th>
                                    <th scope="col" class="ms-0 me-0 text-center">											
                                        <div class="input-group">
                                            <button class="btn btn-custom btn-custom-search" type="submit">
                                                <!--Иконка поиска-->
                                                <img src=""/>
                                            </button>
                                        </div>
